  ...
  >
    ...
    >
      <Typography sx={{ fontFamily: 'inherit', fontSize: 'inherit', lineHeight: 'inherit' }}>
        ...
        . After Monday's surge in technical debt reduction, you successfully refactored the core authentication
        middleware—reducing latency by 14%.
      </Typography>
      <Typography sx={{ fontFamily: 'inherit', fontSize: 'inherit', lineHeight: 'inherit' }}>
        Your contribution pattern suggests a "Deep Work" preference during mid-day blocks. Notably, you closed{' '}
        <Typography component="span" sx={{ color: 'primary.main', fontFamily: 'inherit', fontSize: 'inherit' }}>
          14 high-priority PRs
        </Typography>
        , most of which focused on the new GraphQL orchestration layer. The team's velocity was positively influenced by
        your detailed documentation updates on Wednesday.
      </Typography>
      <Typography
        sx={{
          fontFamily: 'inherit',
